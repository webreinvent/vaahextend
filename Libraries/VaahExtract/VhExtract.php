<?php namespace WebReinvent\VaahExtend\Libraries\VaahExtract;
...
class VhExtract{
    ...
    //-------------------------------------------------
    public static function fetchPageViaCurl($url, $agent = 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.13) Gecko/20080311 Firefox/2.0.0.13', $cookie = '', $referer = '', $post_fields = '', $return_transfer = 1, $follow_location = 1, $ssl = '', $curlopt_header = 0)
    {
        $ch = curl_init();
    ...
    //-------------------------------------------------
    public static function stripAttributes($msg, $tag, $attr = "", $suffix = "")
    {
        $lengthfirst = 0;
...
//$str = iconv("UTF-8", "ISO-8859-1", $str);
    ...
    //-------------------------------------------------
    public static function removeLineBreaks($output)
    {
    ...
    //-------------------------------------------------
    public static function findEmail($content)
    {
    ...
    //-------------------------------------------------
    public static function findPhone($content)
    {
    ...
    //-------------------------------------------------
    public static function findDomains($str)
    {
